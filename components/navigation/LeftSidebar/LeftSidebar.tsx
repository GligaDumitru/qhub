...
const LeftSidebar = async () => {
  ...
  return (
    <section className="custom-scrollbar background-light900_dark-nav-bg light-border shadow-light-300 top-0 left-0 z-30 flex h-full flex-col justify-between overflow-y-auto border-r p-6 max-sm:hidden lg:w-66.5 dark:shadow-none">
