...
const LeftSidebar = async () => {
  ...
  return (
    <section className="custom-scrollbar background-light900_dark-nav-bg light-border shadow-light-300 sticky top-0 left-0 z-30 flex h-screen min-h-screen flex-col justify-between overflow-y-auto border-r p-6 pt-36 max-sm:hidden lg:w-[266px] dark:shadow-none">
