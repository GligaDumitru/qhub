...
const RightSidebar = async () => {
  ...
  return (
    <section className="custom-scrollbar background-light900_dark-nav-bg light-border shadow-light-300 sticky top-0 right-0 flex h-full w-87.5 flex-col gap-6 overflow-y-auto border-l p-6 max-xl:hidden dark:shadow-none">
      <div>
